...
X = pd.read_csv(r"C:\Users\hp\Downloads\rfe\LR\for Ef\pre_EF_data(2).csv")
y = pd.read_csv(r"C:\Users\hp\Downloads\rfe\LR\for Ef\y_EF (1).csv")
...
while(True):
    ...
    with open('output_ef_lr.txt', 'a') as file:
